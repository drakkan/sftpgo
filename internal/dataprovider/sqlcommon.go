...
func sqlCommonAddUserFolderMapping(ctx context.Context, user *User, folder *vfs.VirtualFolder, sortOrder int, dbHandle sqlQuerier) error {
	...
	_, err := dbHandle.ExecContext(ctx, q, folder.VirtualPath, folder.VirtualSubdirectory, folder.QuotaSize, folder.QuotaFiles, folder.Name, user.Username, sortOrder)
	return err
}
...
func sqlCommonAddGroupFolderMapping(ctx context.Context, group *Group, folder *vfs.VirtualFolder, sortOrder int,
	...
	_, err := dbHandle.ExecContext(ctx, q, folder.VirtualPath, folder.VirtualSubdirectory, folder.QuotaSize, folder.QuotaFiles, folder.Name, group.Name, sortOrder)
	return err
}
