...
func TestHTTPDBindingsFromEnv(t *testing.T) {
	...
	os.Setenv("SFTPGO_HTTPD__BINDINGS__2__OIDC__AUTO_LOGIN", "3")
	...
	t.Cleanup(func() {
		...
		os.Unsetenv("SFTPGO_HTTPD__BINDINGS__2__OIDC__AUTO_LOGIN")
	...
	require.Equal(t, 0, bindings[0].OIDC.AutoLogin)
	...
	require.Equal(t, 3, bindings[2].OIDC.AutoLogin)
