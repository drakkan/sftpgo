...
The `post_connect_hook` can be defined as the absolute path of your program or an HTTP URL. If you're using a program you may set arguments using the `post_connect_hook_args` key.
