...
- **"common"**, configuration parameters shared among all the supported protocols
  ...
  - `actions`, struct. It contains the command to execute and/or the HTTP URL to notify and the trigger conditions. See [Custom Actions](./custom-actions.md) for more details
    ...
    - `hook_args`, string. Arguments for the command to execute.
  ...
  - `startup_hook_args`, list of strings. Arguments for the external program
  ...
  - `post_connect_hook_args`, list of strings. Arguments for the external program
  ...
  - `post_disconnect_hook_args`, list of strings. Arguments for the external program
  ...
  - `data_retention_hook_args`, list of strings. Arguments for the external program
...
- **"sftpd"**, the configuration for the SFTP server
  ...
  - `keyboard_interactive_auth_hook_args`, list of strings. Arguments for the external program.
...
- **"data_provider"**, the configuration for the data provider
  ...
  - `actions`, struct. It contains the command to execute and/or the HTTP URL to notify and the trigger conditions. See [Custom Actions](./custom-actions.md) for more details
    ...
    - `hook`, string. Absolute path to the command to execute or HTTP URL to notify.
    - `hook_args`, list of strings. Arguments for the command to execute.
  ...
  - `external_auth_hook_args`, list of strings. Arguments for the external program.
  ...
  - `pre_login_hook_args`, list of strings. Arguments for the external program.
  ...
  - `post_login_hook_args`, list of strings. Arguments for the external program.
  ...
  - `check_password_hook_args`, list of strings. Arguments for the external program.
