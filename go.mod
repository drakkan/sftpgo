...
replace (
	...
	golang.org/x/crypto => github.com/drakkan/crypto v0.0.0-20220113163634-dc0a013512d8
	golang.org/x/net => github.com/drakkan/net v0.0.0-20220113164009-145d52b824e7
)
